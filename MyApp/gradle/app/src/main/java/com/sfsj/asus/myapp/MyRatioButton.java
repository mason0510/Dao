...
public class MyRatioButton extends RadioButton {



                    private int mDrawableSize;// xml文件中设置的大小

                    public MyRatioButton(Context context) {
                   this(context, null, 0);
                }

                     public MyRatioButton(Context context, AttributeSet attrs) {
                    this(context, attrs, 0);
                }

                     public MyRatioButton(Context context, AttributeSet attrs, int defStyle) {
