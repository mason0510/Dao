...
public class DialogUtil {
	...
	public static Dialog showTipDialog(Context context,
			String tipText, int positiveId, int negativeId,
	...
	public static Dialog showTipDialog(Context context,
		...
		String tip = null;
		if(tipID != -1){
			tip = context.getResources().getString(tipID);
		}
		return showTipDialog(context, tip, positiveId, negativeId, cancelable, alertDialogListener);
	}
