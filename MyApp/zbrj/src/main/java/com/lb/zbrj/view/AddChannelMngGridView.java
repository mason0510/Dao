...
public class AddChannelMngGridView extends GridView {
	/** 点击时候的X位置 */
	public int downX;
	/** 点击时候的Y位置 */
	public int downY;
	...
	public AddChannelMngGridView(Context context) {
		super(context);
		init(context);
	}

	public AddChannelMngGridView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}

	public AddChannelMngGridView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	...
	public void init(Context context){
		...
		//将布局文件中设置的间距dip转为px
		mHorizontalSpacing = ImageUtil.convertDipToPx(context, mHorizontalSpacing);
	}
...
//		if (tempPostion != AdapterView.INVALID_POSITION) {
			...
			if(getAdapter() instanceof AddChannelMngAdapter){
				AddChannelMngAdapter mDragAdapter = (AddChannelMngAdapter) getAdapter();
				//显示刚拖动的ITEM
	...
	public void setOnItemClickListener(final MotionEvent ev) {
		setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> parent, View view,
				...
				itemTotalCount = AddChannelMngGridView.this.getCount();
...
//		this.windowParams.y = (y - this.win_view_y + this.viewY);//位置的y值
	...
	private void hideDropItem() {
		if(getAdapter() instanceof AddChannelMngAdapter)
			((AddChannelMngAdapter) getAdapter()).setShowDropItem(false);
	}
