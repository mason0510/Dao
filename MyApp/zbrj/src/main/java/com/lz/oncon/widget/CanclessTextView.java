...
public class CanclessTextView extends RelativeLayout {
	...
	public CanclessTextView(Context context) {
		super(context);
		this.mContext = context;
		init();
	}
	
	public CanclessTextView(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.mContext = context;
		init();
	}
	
	public CanclessTextView(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initListeners(){
		...
		cancleable_textview_IV.setOnClickListener(new OnClickListener(){
			...
			@Override
			public void onClick(View v) {
				CanclessTextView.this.setVisibility(View.INVISIBLE);
