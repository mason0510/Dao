...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	public static final int SMOOTH_SCROLL_DURATION_MS = 350;
     ...
     * 直接刷新
     */
    public void  refresh(Mode currentMode){
	...
	/**
	 * @return Either {@link com.zealther.cloudreader.nuskin.widget.pulltorefresh.PullToRefreshBase.Orientation#VERTICAL} or
	 *         {@link com.zealther.cloudreader.nuskin.widget.pulltorefresh.PullToRefreshBase.Orientation#HORIZONTAL} depending on the scroll direction.
	 */
	public abstract Orientation getPullToRefreshScrollDirection();

	final void setState(State state, final boolean... params) {
       // Log.i("sssss","setState");
		mState = state;
		if (DEBUG) {
	 ...
	 * {@link com.zealther.cloudreader.nuskin.widget.pulltorefresh.PullToRefreshBase.State#PULL_TO_REFRESH} state.
	 */
	...
	/**
	 * Called when the UI has been to be updated to be in the
	 * {@link com.zealther.cloudreader.nuskin.widget.pulltorefresh.PullToRefreshBase.State#REFRESHING} or {@link com.zealther.cloudreader.nuskin.widget.pulltorefresh.PullToRefreshBase.State#MANUAL_REFRESHING} state.
	 * 
	 * @param doScroll - Whether the UI should scroll for this event.
	 */
	protected void onRefreshing(final boolean doScroll) {
        //Log.i("sssss","onRefreshing");
			...
			if (mShowViewWhileRefreshing) {
				...
				OnSmoothScrollFinishedListener listener = new OnSmoothScrollFinishedListener() {
					...
					public void onSmoothScrollFinished() {
                       // Log.i("sssss","onSmoothScrollFinished");
						callRefreshListener();
					}
				};
				...
				switch (mCurrentMode) {
					...
					default:
					case PULL_FROM_START:
                       // Log.i("sssss","PULL_FROM_START："+getHeaderSize());
	...
	/**
	 * Called when the UI has been to be updated to be in the
	 * {@link com.zealther.cloudreader.nuskin.widget.pulltorefresh.PullToRefreshBase.State#RELEASE_TO_REFRESH} state.
	 */
	...
	/**
	 * Called when the UI has been to be updated to be in the
	 * {@link com.zealther.cloudreader.nuskin.widget.pulltorefresh.PullToRefreshBase.State#RESET} state.
	 */
	...
	/**
	 * 当mode设置后更新视图状态.这里不做任何检查，视图总是更新.
	 */
	...
	private void callRefreshListener() {
        Log.i("ssssss",mCurrentMode+":mCurrentMode");
	...
	private void init(Context context, AttributeSet attrs) {
		...
		mRefreshableView = createRefreshableView(context, attrs);//添加主体
		addRefreshableView(context, mRefreshableView);

		// We need to create now layouts now
		mHeaderLayout = createLoadingLayout(context, Mode.PULL_FROM_START, a);//头
		mFooterLayout = createLoadingLayout(context, Mode.PULL_FROM_END, a);//尾
	...
	private final void smoothScrollTo(int newScrollValue, long duration, long delayMillis,
        ...
        //Log.i("sssss","smoothScrollTo:"+newScrollValue);
       ...
       // Log.i("sssss","smoothScrollTo:"+newScrollValue+":"+oldScrollValue);
	...
	public static enum Mode {
		 ...
		 * {@link com.zealther.cloudreader.nuskin.widget.pulltorefresh.PullToRefreshBase#setRefreshing() setRefreshing()}.
		 */
	...
	public static interface OnPullEventListener<V extends View> {
		 ...
		 * @param direction - One of {@link com.zealther.cloudreader.nuskin.widget.pulltorefresh.PullToRefreshBase.Mode#PULL_FROM_START} or
		 *            {@link com.zealther.cloudreader.nuskin.widget.pulltorefresh.PullToRefreshBase.Mode#PULL_FROM_END} depending on which direction
		 *            the user is pulling. Only useful when <var>state</var> is
		 *            {@link com.zealther.cloudreader.nuskin.widget.pulltorefresh.PullToRefreshBase.State#PULL_TO_REFRESH} or
		 *            {@link com.zealther.cloudreader.nuskin.widget.pulltorefresh.PullToRefreshBase.State#RELEASE_TO_REFRESH}.
		 */
	...
	final class SmoothScrollRunnable implements Runnable {
		...
		public void run() {
           ...
           // Log.i("sssss","run:"+mContinueRunning+":"+mScrollToY+":"+mCurrentY);
