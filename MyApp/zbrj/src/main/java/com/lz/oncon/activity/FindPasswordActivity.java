...
public class FindPasswordActivity extends BaseActivity implements SyncListener {
	...
	private void initViews() {
		...
		dialog = new AlertDialog.Builder(FindPasswordActivity.this)
			...
			case R.id.send_verificode:
				{
					...
					if(checkAndToastPhone() == false){
						new NetIFUI_ZBRJ(FindPasswordActivity.this, new com.lb.zbrj.net.NetIFUI.NetInterfaceListener(){
							@Override
			...
			case R.id.btn_register:
				{
					...
					new NetIFUI_ZBRJ(FindPasswordActivity.this, new NetInterfaceListener() {
						@Override
						public void finish(NetInterfaceStatusDataStruct niStatusData) {
	...
	private  class UIHandler extends Handler {
		...
		UIHandler(FindPasswordActivity activity) {
			mActivity = new WeakReference<FindPasswordActivity>(activity);
		}
		@Override
		public void handleMessage(Message msg) {
			final FindPasswordActivity theActivity = mActivity.get();
			switch(msg.what){
